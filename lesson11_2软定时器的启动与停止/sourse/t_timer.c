...
static tTastStack tiemr_task_stack[TINYOS_TIMERTASK_STATCK_SIZE];
...
void timer_module_init()
{
	...
	tTaskInit(&timer_task, t_timer_soft_task, (void *)0, TINYOS_TIMERTASK_PRIO, &tiemr_task_stack[TINYOS_TIMERTASK_STATCK_SIZE]);
