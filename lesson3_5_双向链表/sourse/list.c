...
{
	node->nextnode = list->last_node;
	node->prenode = list->last_node->prenode;
...
tnode * tlist_remove_first (tlist * list)
{
	...
	{
		node = list->first_node;
		list->first_node->nextnode->prenode = &(list->head_node);
		list->head_node.prenode = list->first_node->nextnode;
		list->count --;
